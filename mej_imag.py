...
def procesar_datos(csv_file):
    ...
    resumen_anual.to_csv('resumen_datalake_anual_ul.csv', sep=';', index=False, encoding='utf-8')
    ...
    resumen_mensual_ultimo_anio.to_csv('resumen_datalake_mensual_ultimo_anio_ul.csv', sep=';', index=False, encoding='utf-8')
...
def generar_graficos(resumen_anual, resumen_mensual_ultimo_anio):
    ...
    plt.savefig('evolucion_datalake_ul.png')
    plt.show()
